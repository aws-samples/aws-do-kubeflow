...
import launch_crd
# from kubeflow.pytorchjob import KubeflowOrgV1PyTorchJob as KubeflowOrgV1PyTorchJob_original
# from kubeflow.pytorchjob import KubeflowOrgV1PyTorchJobSpec as KubeflowOrgV1PyTorchJobSpec_original
# from kubeflow.training import KubeflowOrgV1PyTorchJob as KubeflowOrgV1PyTorchJob_original
# from kubeflow.training import KubeflowOrgV1PyTorchJobSpec as KubeflowOrgV1PyTorchJobSpec_original
...
# class KubeflowOrgV1PyTorchJob(KubeflowOrgV1PyTorchJob_original):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
#         #self.openapi_types = self.swagger_types


# class KubeflowOrgV1PyTorchJobSpec(KubeflowOrgV1PyTorchJobSpec_original):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
#         #self.openapi_types = self.swagger_types
...
def get_arg_parser():
    ...
    parser.add_argument('--runPolicy', type=yamlOrJsonStr,
                        default={},
                        help='Job worker runPolicy.')
